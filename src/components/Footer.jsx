...
const Footer = () => {
    return (
        <div>
            <footer className="bg-[#E5F2EF] font-poppins">
                <div className="container p-6 mx-auto">
                        ...
                        <div className="w-full -mx-6 lg:w-2/5">
                            <div className="px-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <h2 className="text-xl text-[#0152A8] font-bold">MedExpress</h2>
                                </div>
                    ...
                    <div>
                        <p className="text-center text-gray-500 ">Copyright © 2024  All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
